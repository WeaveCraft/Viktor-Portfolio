import { Container, Box, Heading, Link, Button, List, ListItem, Divider } from '@chakra-ui/react'
...
import { SiUdemy, SiMicrosoftazure, SiYoutube } from 'react-icons/si'
    ...
    <Layout id="azure">
      <Container>
        <Box borderRadius="lg" bg="#363636" p={3} mb={6} align="center">
          ...
          <span style={{ color: 'white' }}> 'AZURE'</span>
        </Box>

        <Section delay={0.2}>
          <Box flexGrow={1} align="center">
            <Heading as="h2" variant="page-title" >
              <Icon w={16} h={16} color="#48BB78" as={SiMicrosoftazure} />
            </Heading>
          </Box>
